...
public class GreenActivity extends AbstractColorActivity {
    ...
    protected Drawable getDrawable() {
        ...
        BitmapFactory.decodeResource(getResources(), R.drawable.green, options);
        int imageHeight = options.outHeight;
        int imageWidth = options.outWidth;
        String imageType = options.outMimeType;
         fondo = decodeSampledBitmapFromResource(getResources(),R.drawable.green, imageWidth, imageHeight);
